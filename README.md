...
基于 Vue2、 [JSON Schema](https://json-schema.org/understanding-json-schema/index.html) 生成带完整校验的Form表单，你的 :star2: :star2: :star2: 就是最大的支持

本仓库仅维护并发布 **Vue2 + ElementUI** 版本（npm: `@xiaoql/vue-json-schema-form`）。
